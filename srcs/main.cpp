...
int main ()
{
    ...
    HDE::BindingSocket bs = HDE::BindingSocket(AF_INET, SOCK_STREAM, 0, 5050, INADDR_ANY);
    std::cout << "Listening socket..." << std::endl;
    HDE::ListeningSocket ls = HDE::ListeningSocket(AF_INET, SOCK_STREAM, 0, 5050, INADDR_ANY, 10);
